...
](http://www.weiqingeng.com/python/2019/02/21/python-history.html)。
...
![](/assets/images/2019/python/day001-01.png)
...
![](/assets/images/2019/python/day001-02.png)

一路选择 Next，直至安装成功。

### Mac OS Python 安装

>  说明：1. Mac本身自带 Python2.7。2. 允许两个版本共存。
...
安装完成之后，系统将自动拥有了 python2.7 和 python 3 ，可以使用 which 命名来查看 python 的安装路径
...
which python
//brew 安装的 python3.7.2,目录为 /usr/local/bin/python3
which python3
```
...
![](/assets/images/2019/python/day001-03.png)

证明安装成功。

Mac os 下 打开命令行输入 python ，显示结果如下

![](/assets/images/2019/python/day001-04.png)

也可以使用命令： `python --version` 来查看
...
![](/assets/images/2019/python/day001-05.png)
...
我选择使用 Sublime Text ，因为它轻量级，并且我一直只有这个工具写文章，感觉很不错，关于 Sublime Text 3 的快捷键可以查看此文章[Sublime3 使用总结](http://www.weiqingeng.com/other/2015/11/12/sublime3-summary.html)
...
文中示例代码：[python-100-days](https://github.com/weiqingeng/python-100-days)