...
2016年，在一次技术调研的过程中认识到了 Spring Boot ，试用之后便一发不可收拾的爱上它。为了防止学习之后忘记，就在网上连载了 [Spring Boot 系列文章](http://www.weiqingeng.com/spring-boot.html)，没想到这一开始便与 Spring Boot 深度结缘。
...
这个开源项目就是 [spring-boot-examples](https://github.com/weiqingeng/spring-boot-examples)  ，这是一个专注帮助初学者学习 Spring Boot 的开源项目，里面分享了各种场景下 Spring Boot 使用示例，此开源项目下都是一个一个独立的小项目，以最小依赖、最简单的方式呈现出来，非常方便初始者学习。

## [spring-boot-examples(star 12000+)](https://github.com/weiqingeng/spring-boot-examples)  
...
## [awesome-spring-boot(star 1555+)](https://github.com/weiqingeng/awesome-spring-boot)
